    ...
    <div id="FooterComponent">
      <div className="container">
        <Row>
          <Col lg={10} sm={24} xs={24}>
            <div style={{ textAlign: "center" }}>
              ...
              <div className="footer-call-us">
                <div className="footer-call-us-icon">
                  <CustomerServiceOutlined />
                </div>
                <div className="footer-call-us-body">
                  <span className="footer-call-us-text">
                    Got Questions ? Call us 24/7!
                  </span>
                  <span className="footer-call-us-number">
              ...
              <div className="footer-social-icons">
                <ul>
                  ...
                  <li>
                    <Link to="/">
                      <WifiOutlined className="icon-wifi" />
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <Col lg={14} sm={24} xs={24} style={{ paddingLeft: 15 }}>
            <Row>
              <Col md={8} sm={12} xs={24} className="brand-footer">
                <h4 className="brand-footer-title">Find It Fast</h4>
                <ul>
                  <li>
              ...
              <Col md={8} sm={12} xs={24} className="brand-footer">
                <h4 className="brand-footer-title">&nbsp;</h4>
                <ul>
                  <li>
                    <Link to="/">About</Link>
                  </li>
              ...
              <Col md={8} sm={12} xs={24} className="brand-footer">
                <h4 className="brand-footer-title">Customer Care</h4>
                <ul>
                  <li>
